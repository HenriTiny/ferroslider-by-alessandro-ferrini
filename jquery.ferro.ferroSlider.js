...
(function( $ ){
    var methods = {
        ferroSliderCreate : function(options) {
            ...
            var playStartTime = 0;
            var slide = false;
            var sliderClass = this[0].className.replace(".","");
            var slideEndX = 0;
            var slideEndY = 0;
            var slideInitialX = 0;
            var slideInitialY = 0;
            ...
            /*START*/
            $("head").append('<link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/3.0.2/css/font-awesome.css" />');
            ...
            function _actualPage(){
                if (!opts.updateLocation) {
                    return customLocation.replace("!","");
                } else{
            ...
            function _init(){
                ...
                if($.trim(location.hash) != "" || $.trim(customLocation) != ""){
            ...
            function _moveSlide(nextPageId,moveTime){
                ...
                if (!opts.updateLocation) {
                    customLocation = "#!"+nextPageId.replace("#","");
                } else {
